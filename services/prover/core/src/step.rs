...
mod tests {
    ...
    fn ts_parity_zero_input_10_ticks() {
        assert_eq!(
            ...
            "0a000000000000000000000000640000000a00000000000000b40000000000000068010000000000c4f42048010000000200000001000000010000000000000001000000010000000000000001000000a5000000062c05000084000067fcffff008400000000000000000000",
        );
    }
    ...
    fn ts_parity_zero_input_50_ticks() {
        assert_eq!(
            ...
            "32000000000000000000000000640000003200000000000000b40000000000000068010000000000c4f42048010000000200000001000000010000000000000001000000010000000000000001000000a50000001e9c04000084000067fcffff008400000000000000000000",
        );
    }
    ...
    fn ts_parity_zero_input_100_ticks_coffee() {
        assert_eq!(
            ...
            "64000000000000000000000000640000006400000000000000b400000000000000680100000000000e9da889010000000200000001000000010000000000000001000000010000000500000001000000da000000503804000053010034fdffff005301000000000000000000",
        );
    }
    ...
    fn ts_parity_real_corpus_seed_50_ticks() {
        ...
        assert_eq!(
            ...
            "32000000000000000000000000640000003200000000000000b400000000000000680100000000005c944db5010000000200000001000000010000000000000001000000010000000000000001000000fe0000001e9c04000037020067fcffff003702000000000000000000",
        );
    }
    ...
    fn world_distance_accumulates_speed_mul() {
        ...
        assert_eq!(s.world_distance, 5 * SPEED_NORMAL); // 5 × fp(1) = 5×256 = 1280
    }
}
