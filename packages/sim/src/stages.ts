...
export const STAGE_TABLE: readonly StageParams[] = [
  ...
  /* Uncommon */ {
    ...
    scrollSpeed: 2.75,
    fuelEnabled: true,
    fuelDrainPerTick: fp(0.048),  // +20% over original 0.04
  ...
  /* Legendary */ {
    ...
    scrollSpeed: 3.25,
    fuelEnabled: true,
    fuelDrainPerTick: fp(0.072),  // +20% over original 0.06
  ...
  /* Mythical */ {
    ...
    scrollSpeed: 3.5,
    fuelEnabled: true,
    fuelDrainPerTick: fp(0.084),  // +20% over original 0.07
